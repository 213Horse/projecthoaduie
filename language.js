$(document).ready(function() {
    ...
    var arrLang = {
        ...
        'en': {
            ...
            '7': 'HOADUE là một doanh nghiệp sáng tạo, tập trung vào các sản phẩm kỹ thuật số 3C, đồ điện tử tiêu dùng và các thiết bị gia dụng nhỏ mang tính đột phá. Sau 10 năm phát triển, chúng tôi đã trở thành một doanh nghiệp toàn diện, tích hợp nghiên cứu và phát triển sản phẩm, sản xuất, chế tạo, kinh doanh, dịch vụ và thương mại điện tử.',
            '8': 'Quạt cầm tay',
